...
public class TruckConstants {
	...
	public static final String INVALID_TRUCK_TYPE_ERROR = "Failed: invalid truck type";

	// truck data
	public static final String URI = "/truck";
	public static final String TRUCK_ID_URI = "/truck/truckId:1";
	public static final String TRUCK_ID = "truckId:1";
	...
	public static final String BASE_URI = "http://localhost:9090/truck";
